...
docs/validation/release-signing.md
docs/validation/sbom.md
docs/validation/reproducible-builds.md
docs/validation/supported-platforms.md
docs/validation/msrv-policy.md
docs/validation/dependency-update-policy.md
docs/validation/security-advisory-policy.md
docs/validation/responsible-disclosure.md
docs/validation/external-review-status.md
...
require_text docs/validation/release-artifacts.md 'scripts/release/create-release-package.sh'
require_text docs/validation/release-signing.md 'scripts/release/sign-release-artifacts.sh'
require_text docs/validation/sbom.md 'scripts/release/generate-sbom.py'
require_text docs/validation/reproducible-builds.md 'SOURCE_DATE_EPOCH'
require_text docs/validation/msrv-policy.md 'rust-version = "1.88"'
