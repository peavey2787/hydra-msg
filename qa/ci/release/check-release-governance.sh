...
require_text qa/ci/fuzz/check-fuzz.sh 'run_deterministic_fuzz_with_ephemeral_root_lock'
require_text qa/ci/fuzz/check-fuzz.sh 'HYDRA_RUN_COVERAGE_GUIDED_FUZZ'
require_text qa/ci/fuzz/check-fuzz.sh 'trap restore_root_lock 0 1 2 15'
