...
Assert-Text "docs/validation/release-artifacts.md" 'scripts/release/create-release-package.sh'
Assert-Text "docs/validation/release-signing.md" 'scripts/release/sign-release-artifacts.sh'
Assert-Text "docs/validation/sbom.md" 'scripts/release/generate-sbom.py'
Assert-Text "docs/validation/reproducible-builds.md" 'SOURCE_DATE_EPOCH'
Assert-Text "docs/validation/msrv-policy.md" 'rust-version = "1.88"'
