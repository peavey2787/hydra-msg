...
The format is intentionally simple and follows `docs/validation/changelog-policy.md`. HYDRA-MSG is still pre-1.0, so compatibility-breaking changes may happen before the first stable release; every such change must be called out here.
