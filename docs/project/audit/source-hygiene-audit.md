...
This pass checked the repository against the project-specific rules in `docs/roadmap.md`, `crates/README.md`, `examples/README.md`, and `docs/project/public-developer-api.md`.
